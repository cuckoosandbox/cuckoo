...
def choose_package(file_type, file_name):
    ...
    if "DLL" in file_type:
        ...
        return "pdf"
    elif "Rich Text Format" in file_type or "Microsoft Word" in file_type or "Microsoft Office Word" in file_type or ("Composite Document File" in file_type and not "Installer" in file_type) or file_name.endswith(".docx") or file_name.endswith(".doc"):
        return "doc"
