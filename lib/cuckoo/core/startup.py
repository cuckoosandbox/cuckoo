...
from lib.cuckoo.core.log import JsonFormatter
...
def init_logging():
    ...
    fh = logging.handlers.WatchedFileHandler(os.path.join(CUCKOO_ROOT, "log", "cuckoo.json"))
...
def cuckoo_clean():
    ...
    if cfg.elasticsearch and cfg.elasticsearch.enabled:
        ...
        try:
            ...
            cuckoo_template = cuckoo_index + "_template"
            if es.indices.exists_template(cuckoo_template):
