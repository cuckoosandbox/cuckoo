    ...
    configuration = {
        ...
        "reporting": {
            ...
            "misp": {
                ...
                "cuckoo_baseurl": String(required=False),
                "url_ids": Boolean(False, required=False),
                "hash_ids": Boolean(False, required=False),
                "domain_ids": Boolean(False, required=False),
                "ip_ids": Boolean(False, required=False),
                "mutex_ids": Boolean(False, required=False),
                "useragent_ids": Boolean(False, required=False),
                "sample_ids": Boolean(False, required=False),
            },
            "mongodb": {
                "enabled": Boolean(False),
