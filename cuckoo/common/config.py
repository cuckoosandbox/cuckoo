...
class Config(object):
	...
	"esxOssh": {
            "esxOssh": {
                "host": String("192.168.11.3"),
                "vmgroup": String("Cuckoo-SB"),
                "username": String("user"),
		"password": String("pass"), 
                "interface": String("ens224"),
                "machines": List(String, "cuckoo1"),
            },
            "*": {
                "__section__": "cuckoo1",
                "label": String("cuckoo1"),
                "vmid": String(required=False),
                "platform": String("windows"),
                "ip": String("192.168.11.236"),
                "snapshot": String(),
