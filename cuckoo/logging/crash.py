...
def crash():
    ...
    print("If the problem persists ask for help on the official maling list, register at:")
    print("  https://public.honeynet.org/mailman/listinfo/cuckoo")
    print("The developers will try to reproduce the bug, fix it and get in touch with you.")
    print
    print("----------------------------------[TRACEBACK]-----------------------------------")
    print("Cuckoo version: %s" % constants.CUCKOO_VERSION)
