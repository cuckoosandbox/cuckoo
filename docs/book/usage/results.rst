...
All the analyses are stored under the *storage/analyses/* (in the Cuckoo
Working Directory) inside a subdirectory named after the incremental numerical
ID that represents the analysis task in the database.
